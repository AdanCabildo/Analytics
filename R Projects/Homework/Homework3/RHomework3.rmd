...
The due date is 07:30AM 07 Feb 2024 (Wed). Submit BOTH the Knit HTML file and the Rmd file.
...
* Add axis labels, legend labels, and titles. Capitalize the important words in them.
...
Note 3: The required numbers to answer are only PROBLEM 1 and 2. However, if you are up to the challenge, you can answer Problems 3 and 4 as well for bonus points.
